...
const Profile = (props) => {
  ...
  return (
    <View style={profilePage.profileContainer}>
      ...
      <View
        style={isLoggedIn ? profilePage.hidden : profilePage.inputContainer}
      >
        <Text>Username</Text>
        <TextInput
        ...
        <Text>Password</Text>
        <TextInput
          style={[profilePage.inputField, profilePage.defaultMarginBottom]}
          value={password}
          onChangeText={(text) => {
            setPassword(text);
          }}
      ...
      <View
        style={isLoggedIn ? profilePage.inputContainer : profilePage.hidden}
      >
